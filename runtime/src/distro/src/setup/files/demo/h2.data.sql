...
insert into ACT_ID_GROUP values ('manager',     1, 'Manager', 'assignment');
insert into ACT_ID_GROUP values ('clerk',		1, 'Clerk', 'assignment');
insert into ACT_ID_GROUP values ('supervisor',	1, 'Supervisor', 'assignment');
...
insert into ACT_ID_MEMBERSHIP values ('kermit', 'clerk');
insert into ACT_ID_MEMBERSHIP values ('kermit', 'supervisor');
